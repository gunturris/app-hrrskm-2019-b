...
//CUTI PAGE
$$(document).on('page:init', '.page[data-name="formkontak"]', function (e) { 
    ...
    function request_question(){
        ...
        $.post( serverHost + "json_submit_help_kontak.php" , { karyawan_id : kid ,target :target , pertanyaan : pertanyaan  }, function( data ) {
          console.log( data ); 
            if(data.status == 0 ){ 
